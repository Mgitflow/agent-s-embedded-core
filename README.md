...
## <font color="#0366d6">为什么不是「纯 LLM 生成」</font>
...
## <font color="#0366d6">关于「agent」这个名字</font>
...
## <font color="#0366d6">起点是 MX，终点是你</font>
...
所以 **MX 是起点，不是终点**。终点在哪、能走多远，不取决于 MX，取决于你——取决于你填的内容、写的模板、定的规则。只填一个 GPIO，它是个点灯工具；填了完整时钟树和自定义链接脚本，它是台可深度定制的生成引擎。

<font size="5" color="#000000"><b>同一副壳子，取决于装它的人。</b></font>

## <font color="#0366d6">核心特性</font>
