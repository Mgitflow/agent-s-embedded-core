...
/* Includes ------------------------------------------------------------------*/
#include "main.h"
#include <string.h>   /* strlen/memset（真编译验证：模板用 C 库函数须 include） */
...
STM32F4XX_ASSERT_FAILED_TEMPLATE = """#ifdef  USE_FULL_ASSERT
/**
...
STM32F4XX_HAL_MSP_TEMPLATE = """/**
  ******************************************************************************
  * @file    stm32f4xx_hal_msp.c
  * @brief   HAL MSP module（MSP 层：外设底层初始化，由 CubeMX 生成）
  ******************************************************************************
  */
#include "stm32f4xx_hal.h"
...
"""
STM32F4XX_IT_C_TEMPLATE = """/* USER CODE BEGIN Header */
/**
  ******************************************************************************
  * @file           : stm32f4xx_it.c
...
STM32F4XX_IT_H_TEMPLATE = """/* USER CODE BEGIN Header */
/**
  ******************************************************************************
  * @file           : stm32f4xx_it.h
...
SYSTEM_STM32F4XX_TEMPLATE = """/**
  ******************************************************************************
  * @file           : system_stm32f4xx.c
  * @brief          : CMSIS Cortex-M4 Device Peripheral Access Layer
  *                   System Source File for STM32F407xx devices.
  ******************************************************************************
  * Generated by Agent-S-Embedded v{tool_version}
  ******************************************************************************
  */
...
/* Macro to define weak aliases for exception handlers */
...
/* Provide weak aliases for all handlers */
...
ORG_META = {
    ...
    "it_c_template": STM32F4XX_IT_C_TEMPLATE,
    "it_h_template": STM32F4XX_IT_H_TEMPLATE,
    "system_template": SYSTEM_STM32F4XX_TEMPLATE,
